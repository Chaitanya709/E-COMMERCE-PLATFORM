...
Full-stack e-commerce application with a Spring Boot backend, React frontend, MySQL database, and Redis cache — deployable locally or on a VPS via Docker Compose.
